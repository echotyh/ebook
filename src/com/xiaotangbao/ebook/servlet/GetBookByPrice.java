 ...
 * @date    16-6-2 23:34
 */
@WebServlet(name = "GetBookByPrice", urlPatterns = "/servlet/GetBookByPrice")
public class GetBookByPrice extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<Map<String, Object>> grades = bookBiz.getByPriceDesc(offset, pageSize);
            ...
            request.setAttribute("title", "特价图书");
            request.setAttribute("url", request.getContextPath() + "/servlet/GetBookByPrice");
