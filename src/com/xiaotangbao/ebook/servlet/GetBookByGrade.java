 ...
 * @date    16-6-2 23:07
 */
@WebServlet(name = "GetBookByGrade", urlPatterns = "/servlet/GetBookByGrade")
public class GetBookByGrade extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            List<Map<String, Object>> grades = bookBiz.getByGradeDesc(offset, pageSize);
