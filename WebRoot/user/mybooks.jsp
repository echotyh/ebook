...
<html>
  ...
  <body>
  <jsp:include page="<%=basePath%>main/header.jsp"/>
        ...
        <c:forEach items="${requestScope.books}" var="item" varStatus="status">
            <div class="book_box">   <!-- 某一本书 -->
                <div class="cover_box">   <!-- cover -->
                    <a href="${pageContext.request.contextPath}/user/ReadBookSvl?book=${item.bookid}"><img src="${pageContext.request.contextPath}/book-images/${item.bookid}.png"/></a>
                </div>
                <div class="info">   <!-- info -->
